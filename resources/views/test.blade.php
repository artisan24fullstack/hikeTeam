                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-wrap gap-2 justify-content-center py-2">
                                        <span class="badge text-bg-primary rounded-pill">Tag 1</span>
                                        <span class="badge text-bg-primary rounded-pill">Tag 3</span>
                                    </div>
                                    <small class="text-body-secondary"><a href="details.html">View details</a></small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-wrap gap-2 justify-content-center py-2">
                                        <span class="badge text-bg-primary rounded-pill">Tag 1</span>
                                        <span class="badge text-bg-primary rounded-pill">Tag 2</span>
                                    </div>
                                    <small class="text-body-secondary"><a href="details.html">View details</a></small>
                                </div>
                            </div>
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-wrap gap-2 justify-content-center py-2">
                                        <span class="badge text-bg-primary rounded-pill">Tag 2</span>
                                        <span class="badge text-bg-primary rounded-pill">Tag 5</span>
                                    </div>
                                    <small class="text-body-secondary"><a href="details.html">View details</a></small>
                                </div>
                            </div>
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-wrap gap-2 justify-content-center py-2">
                                        <span class="badge text-bg-primary rounded-pill">Tag 3</span>
                                        <span class="badge text-bg-primary rounded-pill">Tag 4</span>
                                    </div>
                                    <small class="text-body-secondary"><a href="details.html">View details</a></small>
                                </div>
                            </div>
